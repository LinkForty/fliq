      ...
      <main className="pt-24 pb-16 px-6">
        <article className="max-w-3xl mx-auto">
          ...
          <div className="space-y-8 text-gray-700 leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-bold text-navy mb-3">Description of Service</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-navy mb-3">Ephemeral Messaging</h2>
              <p>
                Fliq is designed around ephemeral messaging. Push-delivered messages are stored
                on our server temporarily and are deleted once opened or after 24 hours. Messages
                on your device can be configured to auto-delete after reading.
              </p>
              <p className="mt-2">
            ...
            <section>
              <h2 className="text-xl font-bold text-navy mb-3">Disclaimer of Warranties</h2>
              <p>
