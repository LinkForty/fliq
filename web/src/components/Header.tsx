    ...
    <nav className="fixed top-0 w-full z-50 border-b border-white/5 bg-background-dark/80 backdrop-blur-md">
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-3">
          <img src="/fliq-logo.png" alt="Fliq'd" className="size-8 rounded-lg shadow-lg shadow-primary/40" />
          <span className="text-xl font-bold tracking-tight text-white">Fliq'd</span>
        </Link>
